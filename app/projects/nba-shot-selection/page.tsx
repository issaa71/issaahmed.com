...
export const metadata: Metadata = {
  ...
  description:
    "Dueling DQN with per-entity Deep Sets architecture and PBRS reward shaping. Learns shoot-or-pass policies from 116K real NBA SportVU possessions and outperforms NBA player decisions by ~6×.",
};
      ...
      <Section title="Artifacts">
        <ArtifactRow>
          <Artifact
            ...
            detail="Public repo in progress — local code at NBA_Shot_Selection/"
          />
          <Artifact
            href="#"
            label="🛠 Live demo (FastAPI court visualization)"
            detail="Hugging Face Spaces deployment in progress — slimming dataset from 864MB to test-only"
          />
          <Artifact
            href="#"
            label="🛠 Project report (28 pp)"
            detail="Full methodology + results"
          />
        </ArtifactRow>
      </Section>
